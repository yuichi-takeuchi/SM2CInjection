...
% Triggered sham-fiber AMPA input: 29 nS Peak, Erev = 0 mV, Delay = 1 ms, Trise = 0.3 ms, Tdecay = 1.75 ms
CONDUCTANCE_IV DA0 -0.029*v*(0.0165-0.013/(1+exp((0.2-v)/0.2))) DIG16:1:0.3:1.75 AD2

% Triggered S-fiber AMPA input: 24 nS Peak, Erev = 0 mV, Delay = 1 ms, Trise = 0.3 ms, Tdecay = 1.75 ms
CONDUCTANCE_IV DA0 -0.024*v*(0.0165-0.013/(1+exp((0.2-v)/0.2))) DIG17:1:0.3:1.75 AD2

% Triggered W-fiber AMPA input: 3 nS Peak, Erev = 0 mV, Delay = 1 ms, Trise = 0.3 ms, Tdecay = 3 ms
CONDUCTANCE_IV DA0 -0.003*v DIG18:1:0.3:3 AD2

% Triggered sham-fiber NMDA input: 45 nS Peak, Erev = 0 mV, Delay = 1 ms, Trise = 5 ms, Tdecay = 50 ms
CONDUCTANCE_IV DA0 -0.045*v/(1+0.33*exp(-0.06*v)) DIG16:1:5:50 AD2

% Triggered S-fiber NMDA input: 33 nS Peak, Erev = 0 mV, Delay = 1 ms, Trise = 5 ms, Tdecay = 50 ms
CONDUCTANCE_IV DA0 -0.033*v/(1+0.33*exp(-0.06*v)) DIG17:1:5:50 AD2

% Triggered W-fiber NMDA input: 7.5 nS Peak, Erev = 0 mV, Delay = 1 ms, Trise = 5 ms, Tdecay = 50 ms
CONDUCTANCE_IV DA0 -0.0075*v/(1+0.33*exp(-0.06*v)) DIG18:1:5:50 AD2

% Triggered GABAA input: 2 nS Peak, Erev = -67.7 mV, Delay = 1 ms, Trise = 0.5 ms, Tdecay = 7 ms
CONDUCTANCE_IV DA0 -0.002*(v+67.7) DIG19:1:0.5:7 AD2
