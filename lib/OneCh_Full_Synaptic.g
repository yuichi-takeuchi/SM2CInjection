...
% Triggered GABAA input - 2 nS Peak, Erev = -60 mV, Delay = 1.5 ms, Trise = 0.5 ms, Tdecay = 7 ms
%CUNDUCTANCE_IV DA0 -0.002*(v+60) DIG17:1.5:0.5:7 AD2

% Triggered GluA3/4 input - 5 nS Peak, Erev = 0 mV, Delay = 1 ms, Trise = 0.2 ms, Tdecay = 1.5 ms
CUNDUCTANCE_IV DA0 -0.005*v*(0.0165-0.013/(1+exp((0.2-v)/0.2))) DIG16:1:0.2:1.5 AD2

% Triggered GluA2 input - 5 nS Peak, Erev = 0 mV, Delay = 1 ms, Trise = 0.2 ms, Tdecay = 2.5 ms
%CUNDUCTANCE_IV DA0 -0.005*v DIG16:1:0.2:2.5 AD2

% Triggered NMDA input - 2 nS Peak, Erev = 0 mV, Delay = 1 ms, Trise = 5 ms, Tdecay = 40 ms
CUNDUCTANCE_IV DA0 -0.002*v/(1+0.33*exp(-0.06*v)) DIG16:1:5:40 AD2
